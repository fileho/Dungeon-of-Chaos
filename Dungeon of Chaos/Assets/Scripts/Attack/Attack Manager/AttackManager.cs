...
public class AttackManager : MonoBehaviour {
	...
	/// <summary>
	/// Calculates the prirority of an attack based on its Range, Damage and Cost and returns it.
	/// </summary>
	...
	/// <summary>
	/// Iterates through all the IAttacks in the sorted list based on the order of priority
	/// and returns the firsattack  which is available.
	/// </summary>
	/// <returns></returns>
