...
/// <summary>
/// Class defining how the Stomp Indicator works
/// </summary>
public class StompIndicator : MeleeIndicator {
	...
	protected override IEnumerator ShowIndicator ()
	{
		...
		while (time < 1) {
			...
			secondarySprite.color =
				new Color (secondarySprite.color.r, secondarySprite.color.g, secondarySprite.color.b, currentColor);

			sprite.transform.localRotation =
				Quaternion.Lerp (Quaternion.Euler (0, 0, 0), Quaternion.Euler (0, 0, 180), currentRotation);
			secondarySprite.transform.localRotation =
				Quaternion.Lerp (Quaternion.Euler (0, 0, 0), Quaternion.Euler (0, 0, 180), currentRotation);
			yield return null;
		}
